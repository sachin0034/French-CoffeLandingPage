...
const MenuTime = () => {
  ...
  const deleteSuggestion = async (id) => {
    try {
      await axios.delete(
        `${process.env.REACT_APP_SERVER}/api/menu-time/delete/${id}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_SERVER}/api/menu-time/add-menu`,
        formData
      );
  ...
  const handleSubmitEdit = async (e) => {
    ...
    try {
      await axios.put(
        `${process.env.REACT_APP_SERVER}/api/menu-time/update/${selectedSuggestion._id}`,
        eidtformData
      );
      fetchSuggestions();
